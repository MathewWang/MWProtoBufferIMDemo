...
+ (SendReq_Builder*) builder {
  return [[SendReq_Builder alloc] init];
}
...
- (id) init {
  if ((self = [super init])) {
    self.result = [[SendReq alloc] init];
  }
  return self;
}
...
+ (SendRes_Builder*) builder {
  return [[SendRes_Builder alloc] init];
}
...
- (id) init {
  if ((self = [super init])) {
    self.result = [[SendRes alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
