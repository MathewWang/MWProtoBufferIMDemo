...
enum
{
    ...
    DDCMD_LOGIN_REQ_USERLOGIN                     = 999,                //用户登录请求
    DDCMD_LOGIN_RES_USERLOGIN                     = 1000,                //登陆消息服务器验证结果
...
enum
{
    DDCMD_MSG_DATA                        = 3000,            //收到聊天消息
    DDCMD_MSG_RECEIVE_DATA_ACK            = 2001,            //消息收到确认.  这是收
...
enum
{
    LOGIN_SERVICE_ID     = 100,
    SENDMSG_SERVICE_ID   = 200,
    RECEMSG_SERVICE_ID   = 300,
    HEARTBEAT_SERVICE_ID = 400,
};
...
enum
{
    LOGIN_CMD_ID         = 1000,
    SENDMSG_CMD_ID       = 2000,
    RECEMSG_RES_CMD_ID   = 3000,
    HEARTBEAT_CMD_ID     = 4000,
};
